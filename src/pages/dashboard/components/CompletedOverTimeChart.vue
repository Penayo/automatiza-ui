...
import type { CompletedOverTime } from '../../../services/DashboardService';

const props = defineProps<{ data: CompletedOverTime[] }>();
...
<template>
  <div class="w-full">
    ...
    <div v-if="!data.length" class="text-center text-gray-400 text-sm mt-2">
