...
import InstancesOverTimeChart from './components/InstancesOverTimeChart.vue';
import CompletionRateChart from './components/CompletionRateChart.vue';
import ProcessDurationCard from './components/ProcessDurationCard.vue';
import BottleneckChart from './components/BottleneckChart.vue';
import ActiveInstancesChart from './components/ActiveInstancesChart.vue';
import FailureRateChart from './components/FailureRateChart.vue';
import InstanceFlowHeatmap from './components/InstanceFlowHeatmap.vue';
